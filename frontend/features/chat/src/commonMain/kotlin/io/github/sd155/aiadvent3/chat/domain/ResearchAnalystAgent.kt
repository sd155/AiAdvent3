...
internal class ResearchAnalystAgent(
    apiKey: String,
) {
    ...
    private suspend fun systemPrompt(): LlmContextElement.System =
        LlmContextElement.System(
            prompt =
                """
                You are an experienced research analyst. You must take the user's prompt and respond with expert-level research.                
    ...
    internal suspend fun research(
        userPrompt: LlmContextElement.User

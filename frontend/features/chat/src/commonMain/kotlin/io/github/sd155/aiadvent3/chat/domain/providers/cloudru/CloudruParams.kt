...
internal fun LLMParams.toCloudruParams(): CloudruParams {
    if (this is CloudruParams) return this
    return CloudruParams(
...
/**
 * Cloud.ru chat-completions parameters layered on top of [LLMParams].
 *
 ...
 */
public open class CloudruParams(
    ...
    override fun hashCode(): Int = listOf(
        ...
        topA, transforms, models, route,
    ).fold(0) { acc, element ->
        31 * acc + (element?.hashCode() ?: 0)
    }

    override fun toString(): String = buildString {
        append("CloudruParams(")
